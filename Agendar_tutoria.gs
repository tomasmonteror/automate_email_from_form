function agendarTutoria(e) {
  ...
  var tema = e.namedValues['¿Cuál es el tema principal que te gustaría tratar en la tutoría?'][0];
  ...
  if (eventosExistentes.length > 0) {
    ...
    var mensajeOcupado = 'Hola ' + nombrePadre + ',\n\n' +
                         ...
                         'Enlace al formulario: https://forms.gle/FUbRTBFtva5fqypN9 \n\n' + 
                         'Un saludo,\nTu Profesor/a';
  ...
  var mensaje = 'Hola ' + nombrePadre + ',\n\n' +
                'Se ha agendado correctamente la tutoría para hablar sobre ' + nombreAlumno + '.\n\n' +
                'Fecha: ' + fecha + '\n' +
                '⏰ Hora: ' + hora + '\n' +
                'Modalidad: ' + modalidad + '\n' +
                informacionLugar + '\n\n' + 
